...
namespace YTE.BusinessLogic.Implementation.VideoGame.Mapping
{
    public class VideoGameProfile : Profile
    {
        public VideoGameProfile()
        {
            CreateMap<CreateVideoGameModel, Entities.ArtObject>()
            .ForMember(a => a.Id, a => a.MapFrom(s => Guid.NewGuid()))
            .ForMember(a => a.IsDeleted, a => a.MapFrom(s => false));

            CreateMap<CreateVideoGameModel, Entities.VideoGame>();

            CreateMap<Entities.VideoGame, ListVideoGameModel>()
            ...
            CreateMap<Entities.VideoGame, DetailsVideoGameModel>()
                .ForMember(a => a.Name, a => a.MapFrom(s => s.ArtObject.Name))
                .ForMember(a => a.Author, a => a.MapFrom(s => s.ArtObject.Author))
            ...
            CreateMap<Entities.VideoGame, EditVideoGameModel>()
                .ForMember(a => a.Name, a => a.MapFrom(s => s.ArtObject.Name))
                .ForMember(a => a.Author, a => a.MapFrom(s => s.ArtObject.Author))
                .ForMember(a => a.ReleaseDate, a => a.MapFrom(s => s.ArtObject.ReleaseDate.Date))
                .ForMember(a => a.Description, a => a.MapFrom(s => s.ArtObject.Description))
            ...
            CreateMap<EditVideoGameModel, Entities.VideoGame>();

            CreateMap<DetailsVideoGameModel, Entities.VideoGame>();
        }
    }
}
